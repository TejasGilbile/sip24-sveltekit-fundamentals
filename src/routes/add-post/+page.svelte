...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xl font-bold font-['PT_Sans']">Craftlab</h1>
        <a href="/" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">Home</a>
    </div>
</header>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="text-white bg-yellow-700 hover:bg-yellow-800 font-medium rounded-lg text-sm px-5 py-2.5">Share</button>
</form>  
